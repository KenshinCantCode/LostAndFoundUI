...
<!-- main Section -->
<div class="main-section relative overflow-hidden rounded-[2rem] bg-ink p-8 text-white shadow-xl sm:p-12 lg:p-16">
    <div class="grid items-center lg:grid-cols-2">
        <div>
            <p class="mb-4 text-sm font-bold uppercase tracking-[0.2em] text-coral">Lost and Found</p>
            <h1 class="font-display mb-4 text-4xl font-bold leading-tight sm:text-6xl">Lost something? <span class="text-coral">Find it here.</span></h1>
            <p class="mb-8 max-w-xl text-lg leading-8 text-slate-300">Report lost or found items, discover possible matches, and help campus belongings make their way home.</p>
            <div class="flex flex-wrap gap-3">
                <?php if (isset($_SESSION['user_id'])): ?>
                <a href="report-lost.php" class="rounded-xl bg-white px-5 py-3 font-bold text-ink shadow-sm transition hover:-translate-y-0.5">
                    <i class="fas fa-frown mr-2 text-coral"></i>Report Lost Item
                </a>
                <a href="report-found.php" class="rounded-xl border border-white/30 px-5 py-3 font-bold text-white transition hover:bg-white/10">
                    <i class="fas fa-smile mr-2 text-mint"></i>Report Found Item
                </a>
                <?php else: ?>
                <a href="register.php" class="rounded-xl bg-white px-5 py-3 font-bold text-ink shadow-sm transition hover:-translate-y-0.5">
                    <i class="fas fa-user-plus mr-2 text-coral"></i>Get Started
                </a>
                <a href="login.php" class="rounded-xl border border-white/30 px-5 py-3 font-bold text-white transition hover:bg-white/10">
        ...
        <div class="hidden text-center lg:block">
            <i class="fas fa-search-location text-[10rem] text-white/10"></i>
        </div>
    </div>
</div>
